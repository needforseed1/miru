...
ApplicationWindow {
    ...
    Rectangle {
        id: streamPrewarmPopup
        readonly property var stats: appController.streamPrewarmStats || ({})

        visible: stats.active === true
        z: 20
        anchors.top: parent.top
        anchors.right: parent.right
        anchors.topMargin: Theme.s20
        anchors.rightMargin: Theme.s24
        width: Math.min(360, root.width - Theme.s32 * 2)
        height: prewarmBody.implicitHeight + Theme.s16 * 2
        radius: Theme.rLg
        color: Theme.surface
        border.width: 1
        border.color: Theme.lineStrong
        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                Text {
                    text: streamPrewarmPopup.stats.state || "Connecting"
                    color: Theme.gold
            ...
            GridLayout {
                ...
                Text { text: "Received"; color: Theme.textMute; font.pixelSize: Theme.fSmall }
                Text {
                    Layout.fillWidth: true
                    text: root.formatBytes(streamPrewarmPopup.stats.bytesReceived)
                    color: Theme.text
                ...
                Text { text: "Speed"; color: Theme.textMute; font.pixelSize: Theme.fSmall }
                Text {
                    Layout.fillWidth: true
                    text: root.formatSpeed(streamPrewarmPopup.stats.speedBytesPerSecond)
                    color: Theme.text
                    font.pixelSize: Theme.fSmall
                    horizontalAlignment: Text.AlignRight
                    elide: Text.ElideRight
                ...
                Text { text: "Elapsed"; color: Theme.textMute; font.pixelSize: Theme.fSmall }
                Text {
                    Layout.fillWidth: true
                    text: root.formatElapsed(streamPrewarmPopup.stats.elapsedMs)
                    color: Theme.text
                    font.pixelSize: Theme.fSmall
                    horizontalAlignment: Text.AlignRight
                    elide: Text.ElideRight
                ...
                Text {
                    visible: !!streamPrewarmPopup.stats.httpStatus
                    text: "HTTP"
                ...
                Text {
                    visible: !!streamPrewarmPopup.stats.httpStatus
                    Layout.fillWidth: true
                    text: String(streamPrewarmPopup.stats.httpStatus)
                    color: Theme.text
                    font.pixelSize: Theme.fSmall
                    horizontalAlignment: Text.AlignRight
                    elide: Text.ElideRight
            ...
            Text {
                visible: !!streamPrewarmPopup.stats.contentRange
                Layout.fillWidth: true
                text: streamPrewarmPopup.stats.contentRange || ""
                color: Theme.textMute
                font.pixelSize: Theme.fTiny
                maximumLineCount: 1
